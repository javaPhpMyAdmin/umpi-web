...
/**
 * '31 de julio de 2026' — Spanish label for LEGAL_VERSION.
...
export const LEGAL_GATE_SUMMARY =
  'En UMPI usamos tus datos (nombre, correo y teléfono) solo para gestionar tu cuenta, mostrar tus publicaciones y facilitar el contacto entre compradores y vendedores. Aplicamos medidas de seguridad para protegerlos.'
