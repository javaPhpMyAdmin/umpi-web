...
export default function LoginPage() {
  ...
  const { login, loginWithGoogle, sendMagicLink, isLoggingIn, isLoggingInWithGoogle, isSendingMagicLink, loginError } = useAuth()
          ...
          {magicLinkSent ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Remember & Forgot — only in password mode */}
                {authMode === 'password' && (
                ...
                <button
                  type="submit"
                  disabled={isLoggingIn || isSendingMagicLink}
