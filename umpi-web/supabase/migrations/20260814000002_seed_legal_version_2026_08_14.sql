-- Migration: seed legal version '2026-08-14'
--
-- The privacy policy gained the account-deletion section (Play Store
-- compliance); the frontend bumps LEGAL_VERSION to '2026-08-14' (see
...
-- text — same contract as 20260731000005 / 20260801000001.
